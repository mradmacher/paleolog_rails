$(function() {
  ...
  get_species = function(counting_id, filter_params, callback) {
    var params = 'counting_id=' + counting_id + '&' + $.param(filter_params);
  ...
  get_countings = function(well_id, callback) {
		$.get( "/countings.json", { well_id: well_id }, function(countings) {
      callback(countings);
    });
  }
  ...
  load_countings = function() {
    get_countings(get_selected_well(), function(countings) {
  ...
  populate_tag = function(source, vector, index, well_id, counting_id) {
    switch(source) {
      ...
      case 'species': 
        get_species(counting_id, get_filter_params(vector, index), function(species) {
